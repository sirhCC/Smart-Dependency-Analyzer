...
export interface DependencyGraph {
  readonly nodes: Array<{ id: string; label: string; type: DependencyType }>;
  readonly edges: Array<{ from: string; to: string; type: DependencyType }>;
}
...
export interface VulnerabilityReport {
  ...
  readonly riskFactors: Array<{ factor: string; impact: number; description: string }>;
